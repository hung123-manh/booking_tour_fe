    ...
    <div className="profile-modal">
      <div className="profile-content">
        ...
        <div className="booking-history">
          ...
          {bookings.length === 0 ? (
            <p className="no-bookings">Bạn chưa có tour nào được đặt.</p>
          ) : (
            <ul className="booking-list">
              {bookings.map((booking) => (
                <li
                  key={booking.id}
                  className={`booking-item booking-${booking.status.toLowerCase()}`}
                >
                  <div className="booking-info">
                    <span className="booking-tour">{booking.tourName}</span>
